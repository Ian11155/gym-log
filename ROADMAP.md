...
- Cross-device/shared data is implemented through Supabase auto-push and auto-pull, with deployed two-account browser QA passing; it still needs real friend-phone QA.
