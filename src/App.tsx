    ...
    <div className="h-dvh overflow-hidden bg-black text-[#e0dfd5] font-sans select-none antialiased">
      ...
      <div className="mx-auto flex h-dvh w-full max-w-[480px] flex-col overflow-hidden bg-[#181818] shadow-[0_0_24px_rgba(0,0,0,0.5)] md:border-x md:border-[#2d2729]">
        ...
        <main className="relative min-h-0 flex-1 overflow-hidden selection:bg-[#6f6d6c] selection:text-white">
          ...
          <div className="relative z-10 h-full overflow-y-auto overscroll-contain pb-[63px] text-left scrollbar-none">
            {currentTab === 1 && (
              <HomeCombinedTab
          ...
          <nav className="fixed bottom-0 left-1/2 z-[60] flex h-[55px] w-full max-w-[480px] -translate-x-1/2 items-center justify-around border-t border-[#6f6d6c]/15 bg-black px-2 shadow-[0_-6px_18px_rgba(0,0,0,0.45)]">
            <button
              type="button"
              onClick={() => {
                setCurrentTab(1);
