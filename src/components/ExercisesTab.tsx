...
export default function ExercisesTab({
  ...
  return (
    <div id="exercises-tab" className="px-5 py-5 space-y-5">
      ...
      {/* Toast Notification */}
      {toastMessage && (
        <div className="fixed top-12 left-1/2 transform -translate-x-1/2 z-50 bg-[#1c181a] text-white border border-[#6f6d6c]/25 px-4 py-3 rounded-2xl font-black text-[15px] shadow-3d-sm flex items-center gap-2.5 font-sans">
      ...
      <div className="bg-black p-4.5 rounded-2xl border border-[#6f6d6c]/15 shadow-3d-sm text-left font-sans">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-[13px] font-black text-[#f7f5f4] uppercase tracking-widest font-mono">Synchronized Squad Hub</h4>
        </div>
      ...
      <div className="relative font-sans">
        ...
        <input
          ...
          className="w-full bg-black border border-[#6f6d6c]/15 rounded-xl pl-10 pr-4 py-3.5 text-[15px] text-stone-250 placeholder-stone-605 focus:outline-none focus:border-[#6f6d6c]/50 shadow-inner"
        />
      </div>
      ...
      <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-none font-sans">
        {bodyParts.map((bp) => (
          <button
            ...
            className={`px-4 py-2 rounded-xl text-[13px] font-black uppercase tracking-widest whitespace-nowrap transition-all duration-305 transform cursor-pointer ${
              selectedBodyPart === bp
      ...
      <div className="space-y-2.5 max-h-[380px] overflow-y-auto pr-1 scrollbar-thin font-sans">
        {filteredExercises.map((ex) => (
          ...
          >
            <div className="flex items-center gap-3 text-left">
              ...
              <div>
                <h5 className="text-[14.5px] font-black text-[#f7f5f4] group-hover:text-white transition duration-200">{ex.name}</h5>
                <div className="flex items-center gap-1.5 mt-1.5 font-sans">
                  <span className="text-[11px] bg-black border border-[#6f6d6c]/10 text-stone-400 px-2 py-0.5 rounded uppercase font-bold tracking-wider">
                    {ex.body_part}
                  </span>
                  <span className="text-[11px] bg-black text-stone-300 px-2 py-0.5 rounded uppercase font-black tracking-wider border border-[#6f6d6c]/20">
                    {ex.category}
                  </span>
                </div>
              </div>
            ...
            <div className="text-right flex items-center gap-2">
              {ex.is_custom ? (
                <span className="text-[12px] bg-[#6f6d6c]/15 text-[#f7f5f4] px-2.5 py-1 rounded-lg border border-[#6f6d6c]/20 font-bold font-mono">
                  by {getCreatorName(ex.created_by)}
                </span>
              ) : (
                <span className="text-[12px] text-stone-600 font-mono tracking-wide uppercase font-bold">
                  Global
                </span>
              )}
        ...
        {filteredExercises.length === 0 && (
          <div className="p-8 text-center bg-stone-900/10 text-stone-500 text-[15px] rounded-xl border border-dashed border-[#6f6d6c]/20 font-sans">
      ...
      <div className="pt-2">
        ...
        >
          ...
          <span className="text-[13px]">Add Custom Movement</span>
        </button>
      </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 animate-fade-in text-left font-sans">
            <div className="w-full max-w-sm bg-black border border-[#2d2729] rounded-3xl shadow-3d-md p-6 space-y-4 text-stone-100 animate-slide-up relative overflow-hidden">
              ...
              <div className="text-center space-y-2 pt-2">
                ...
                <div>
                  <h3 className="text-[19px] font-black text-stone-100 uppercase tracking-tight">{selectedDetailExercise.name}</h3>
                  <p className="text-[12px] text-[#6f6d6c] font-black tracking-widest uppercase mt-0.5 font-mono">
              ...
              <div className="flex border-b border-[#6f6d6c]/15 font-sans">
                <button
                  ...
                  className={`flex-1 pb-2.5 text-[13px] font-black uppercase tracking-wider text-center border-b-2 transition duration-200 cursor-pointer ${
                    detailTab === "summary"
              ...
              {detailTab === "summary" ? (
                <div className="space-y-4 animate-fade-in">
                  ...
                  <div className="bg-black p-3.5 rounded-2xl border border-[#6f6d6c]/10 space-y-2.5">
                    <div className="flex items-start gap-2.5">
                      ...
                      <div>
                        <span className="text-[11px] uppercase font-bold text-stone-500 tracking-wider block">Primary Muscle</span>
                        <span className="text-[14px] font-bold text-stone-200">{muscles.primary}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-2.5 border-t border-stone-900/60 pt-2.5">
                      ...
                      <div>
                        <span className="text-[11px] uppercase font-bold text-stone-500 tracking-wider block">Secondary Muscles</span>
                        <span className="text-[14px] text-stone-400 font-semibold">{muscles.secondary}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2.5">
                    <div className="flex items-center justify-between">
                      <span className="text-[12px] uppercase font-black text-stone-450 tracking-widest font-mono">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="bg-black p-3 rounded-2xl border border-white/5 text-left relative overflow-hidden">
                        ...
                        <span className="text-[10.5px] uppercase font-bold text-stone-500 tracking-widest block font-sans">
                          Heaviest Lift
                        </span>
                        <span className="font-mono text-[15px] font-black text-[#f7f5f4] block mt-1">
                          {records.heaviestWeight > 0 ? (
                            <>
                              {records.heaviestWeight} <span className="text-[11px] font-sans font-bold text-stone-450 uppercase">kg</span>
                            </>
                          ) : (
                            "None yet"
                          )}
                        </span>
                        <span className="text-[10px] text-[#6f6d6c] font-mono font-bold block mt-1 truncate">
                      ...
                      <div className="bg-black p-3 rounded-2xl border border-white/5 text-left relative overflow-hidden">
                        ...
                        <span className="font-mono text-[15px] font-black text-[#f7f5f4] block mt-1 truncate">
                    ...
                    {records.totalSetsPerformed > 0 && (
                      <div className="flex items-center justify-between px-2 text-[12px] text-stone-400 font-mono">
                ...
                <div className="space-y-3 max-h-[280px] overflow-y-auto pr-1 scrollbar-thin animate-fade-in">
                  {historyLogs.length === 0 ? (
                    <div className="py-12 text-center text-stone-500 text-[15px] font-sans">
                    ...
                    historyLogs.map((item, idx) => (
                      <div key={idx} className="border-b border-stone-800/80 pb-3 last:border-b-0">
                        ...
                        <div className="mb-2">
                          <h4 className="text-[15px] font-black text-[#f7f5f4] hover:text-[#6f6d6c] transition duration-150 flex items-center justify-between">
                            <span>{item.workout_title}</span>
                          </h4>
                          <span className="text-[11.5px] text-stone-500 font-bold block mt-0.5">
                        ...
                        <div className="bg-black p-3 rounded-2xl border border-[#6f6d6c]/10 space-y-2.5">
                          <div className="flex items-center gap-2.5 pb-2 border-b border-stone-900/60 font-sans">
                            ...
                            <span className="text-[15px] font-bold text-stone-205">{selectedDetailExercise.name}</span>
                          </div>

                          {/* Set & Weights Column Headers */}
                          <div className="flex justify-between text-[11px] font-black tracking-widest text-[#6f6d6c] uppercase font-mono pb-1">
                            <span>SET</span>
                          ...
                          <div className="space-y-1">
                            {item.sets.map((set, setIdx) => (
                              <div
                                key={setIdx}
                                className={`flex justify-between items-center px-3 py-2 rounded-xl text-[15px] font-sans font-semibold ${
              ...
              <div className="pt-2">
                <button
                  type="button"
                  onClick={() => setSelectedDetailExercise(null)}
                  className="w-full bg-[#6f6d6c] hover:bg-[#868382] text-white font-black text-[13px] uppercase tracking-widest py-3 px-4 rounded-xl transition duration-200 shadow-3d-emerald text-center cursor-pointer"
                >
                  Close Stats View
                </button>
              </div>
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 animate-fade-in text-left font-sans">
          <div className="w-full max-w-sm bg-black border border-[#2d2729] rounded-3xl shadow-3d-md p-6 space-y-4 text-stone-100 animate-slide-up">
            <h3 className="text-[19px] font-bold text-[#f7f5f4] flex items-center gap-2">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-[11px] uppercase font-black text-stone-400 tracking-widest mb-1.5 font-sans">
                  Exercise Name
                </label>
                <input
                  type="text"
                  ...
                  className="w-full bg-black border border-[#6f6d6c]/15 rounded-xl px-3 py-2.5 text-[15px] text-stone-200 placeholder-stone-605 focus:outline-none focus:border-[#6f6d6c]/50 shadow-inner font-sans"
                  autoFocus
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-black border border-[#6f6d6c]/15 rounded-xl px-2 py-2.5 text-[15px] text-stone-300 focus:outline-none focus:border-[#6f6d6c]/50 shadow-3d-sm font-sans"
                  >
              ...
              <div className="flex gap-2.5 pt-3">
                <button
                  ...
                  className="flex-1 bg-black hover:bg-stone-900 text-[13px] font-black uppercase tracking-widest py-2.5 px-3 rounded-xl text-stone-400 transition cursor-pointer font-bold font-sans"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 bg-[#6f6d6c] hover:bg-[#868382] disabled:opacity-30 text-white font-black text-[13px] uppercase tracking-widest py-2.5 px-3 rounded-xl transition cursor-pointer shadow-3d-emerald font-sans"
                >
                  Sync & Add
                </button>
              </div>
