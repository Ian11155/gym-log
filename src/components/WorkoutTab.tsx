    ...
    <div id="workout-dashboard-tab" className="px-5 py-4 space-y-5">
      ...
      <div className="flex items-center justify-between pt-1 pb-1">
        <div className="flex items-center gap-1.5">
          <h2 className="text-[22px] font-bold font-sans tracking-tight text-white">Workout</h2>
          <span className="text-[13px] bg-stone-900/40 p-1 text-stone-400 rounded-lg cursor-pointer">▼</span>
        </div>
        <span className="bg-yellow-500 text-black text-[12px] font-black uppercase px-2 py-1 rounded-md tracking-wider shadow-inner">
          PRO
        </span>
      </div>
      ...
      <button
        ...
        className="w-full bg-[#141414] hover:bg-[#1f1f1f] active:translate-y-0.5 text-white font-sans font-bold text-[15px] py-4 px-4 rounded-xl border border-[#6f6d6c]/25 flex items-center justify-center gap-2 transition shadow-3d-sm cursor-pointer hover:border-[#6f6d6c]/40"
      >
      ...
      <div className="flex items-center justify-between pt-1 border-b border-[#2d2729] pb-2">
        <h3 className="text-[15px] font-bold text-stone-300 tracking-wide uppercase font-mono">Routines</h3>
        <button
          onClick={() => {
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div className="text-left">
            <span className="text-[13px] font-black uppercase text-stone-200 block">New Routine</span>
            <span className="text-[10.5px] text-stone-550 uppercase font-mono mt-0.5 tracking-wider block">PREPARATION</span>
          </div>
        </button>
        ...
        >
          ...
          <div className="text-left">
            <span className="text-[13px] font-black uppercase text-stone-200 block">Explore</span>
            <span className="text-[10.5px] text-stone-550 uppercase font-mono mt-0.5 tracking-wider block">GYM MOVEMENTS</span>
          </div>
        </button>
      </div>
      ...
      {showBanner && (
        <div className="bg-[#fef8e2] border border-yellow-250/30 p-2.5 rounded-xl flex items-center justify-between text-left shadow-3d-sm relative">
          <div className="flex items-center gap-2 pr-4">
            ...
            <p className="text-[13px] font-bold text-yellow-800 leading-tight">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-1.5 text-[13px] font-black uppercase tracking-widest text-[#a3a3a6]">
        ...
        <div className="space-y-4">
              ...
              >
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1 pr-3">
                    <h4 className="text-[15px] font-black text-[#f7f5f4]">
                      {routine.title}
                    </h4>
                    {/* List of exercises comma-separated */}
                    <p className="text-[13.5px] text-stone-450 mt-1 lines-clamp-3 leading-relaxed">
                    ...
                    <span className="inline-block mt-3 bg-[#1c181a] border border-[#2d2729] text-[12px] font-mono text-stone-400 px-2 py-0.5 rounded font-black tracking-wider uppercase">
                ...
                <button
                  ...
                  className="w-full bg-[#007aff] hover:bg-[#1a85fe] active:translate-y-0.5 text-white text-[13.5px] font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition cursor-pointer shadow-[0_4px_12px_rgba(0,122,255,0.25)]"
                >
          ...
          >
            ...
            <span className="text-[15px] font-bold leading-normal">Add new routine</span>
          </div>
        </div>
      </div>
          ...
          <div className="w-full max-w-sm bg-[#171717] border border-[#6f6d6c]/30 rounded-3xl shadow-3d-md p-6 space-y-4.5 text-stone-100 text-left animate-slide-up scrollbar-thin max-h-[92vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between border-b border-[#2d2729] pb-3">
              <div className="flex items-center gap-2">
                ...
                <h4 className="text-[17px] font-black uppercase tracking-widest text-[#f7f5f4]">New Routine Draft</h4>
              </div>
              <button
            ...
            <div className="space-y-3.5 text-left">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#6f6d6c] border border-white/10 rounded-xl px-3.5 py-2.5 text-[15px] text-white placeholder-stone-250 font-bold focus:outline-none focus:border-white/30 shadow-inner"
                  autoFocus
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-[#6f6d6c] border border-white/10 rounded-xl px-3.5 py-2 text-[15px] text-white placeholder-stone-250 focus:outline-none focus:border-white/30 shadow-inner"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 max-h-75 overflow-y-auto pr-1 scrollbar-thin">
                  ...
                  <div key={idx} className="bg-[#242022] p-3 rounded-xl border border-[#6f6d6c]/15 relative">
                    ...
                    <div className="flex items-center justify-between border-b border-white/5 pb-2 mb-2">
                       <div className="flex items-center gap-2 min-w-0 pr-4">
                        ...
                        <span className="text-[13px] font-black text-[#f7f5f4] truncate">
                          {idx + 1}. {getFullExerciseName(rte.exercise_id)}
                        </span>
                      </div>
                      <button
                        onClick={() => handleRemoveExFromTemplate(idx)}
                        className="text-stone-500 hover:text-red-405 text-[15px] font-black p-0.5"
                      >
                        ✕
                      </button>
                    </div>
                          ...
                          <tr key={sIdx} className="border-t border-[#1c181a]/55">
                            ...
                            <td className="py-1">
                              <select
                                ...
                                className="bg-[#1c181a] text-[12px] text-stone-300 font-bold border border-white/5 rounded py-0.5 px-1 focus:outline-none"
                              >
                            ...
                            <td className="py-1 text-center font-mono">
                              <input
                                ...
                                className="w-12 bg-[#1c181a] text-center font-bold text-stone-200 border border-white/5 rounded py-0.5 text-[12px]"
                              />
                            </td>
                            <td className="py-1 text-center font-mono">
                              <input
                                ...
                                className="w-10 bg-[#1c181a] text-center font-bold text-stone-200 border border-white/5 rounded py-0.5 text-[12px]"
                              />
                            </td>
                    ...
                    <button
                      ...
                      className="w-full text-center text-[11px] uppercase tracking-widest text-stone-400 hover:text-stone-200 py-1 border border-dashed border-[#6f6d6c]/15 rounded-lg mt-2 font-black cursor-pointer bg-stone-900/5 hover:bg-stone-900/15"
                    >
                      + Add Set Row
                    </button>
                  </div>
                ...
                {newRoutineExs.length === 0 && (
                  <div className="p-6 text-center text-stone-500 text-[13px] bg-stone-900/10 border border-dashed border-[#6f6d6c]/10 rounded-xl leading-normal">
            ...
            <div className="pt-1 select-none">
              {!showExPicker ? (
                <button
                  ...
                  className="w-full bg-[#6f6d6c] hover:bg-[#868382] text-white text-[13px] font-black uppercase tracking-widest py-3 px-4 rounded-xl border border-white/10 flex items-center justify-center gap-2 cursor-pointer shadow-inner hover:scale-[1.01] transition-all"
                >
                ...
                <div className="bg-black p-4 rounded-xl border border-[#6f6d6c]/25 space-y-3">
                  <div className="flex justify-between items-center text-[11px] uppercase font-black text-stone-400 tracking-wider">
                  ...
                  <input
                    ...
                    className="w-full bg-[#1c181a] border border-[#6f6d6c]/15 rounded-lg px-2 py-1.5 text-[13px] text-stone-100 focus:outline-none focus:border-[#6f6d6c]/45 font-sans"
                  />
                  ...
                  <div className="flex gap-1 overflow-x-auto pb-1 no-scrollbar select-none">
                    {["All", "Chest", "Legs", "Back", "Shoulders", "Arms", "Core"].map((bp) => (
                      <button
                        ...
                        className={`text-[11px] font-bold px-2.5 py-1 rounded-full transition-all cursor-pointer flex-shrink-0 ${
                          selectedBodyPart === bp
                  ...
                  <div className="max-h-40 overflow-y-auto space-y-1.5 pr-1 scrollbar-thin">
                    {filteredExercises.map(ex => {
                      ...
                      <button
                        ...
                        className="w-full text-left bg-[#1c181a] hover:bg-[#2d2729] px-2.5 py-2 rounded-lg text-[13px] border border-white/5 flex items-center justify-between gap-2.5 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
                      >
                        ...
                        <span className="text-[10.5px] bg-stone-900/60 p-0.5 px-1 rounded font-mono text-stone-500 uppercase">
            ...
            <div className="flex gap-2.5 pt-3.5 border-t border-[#2d2729]">
              <button
                type="button"
                onClick={() => setIsCreatorOpen(false)}
                className="flex-1 bg-[#6f6d6c] hover:bg-[#868382] text-[13px] font-black uppercase tracking-widest py-3 px-3 rounded-xl text-white transition cursor-pointer border border-white/10"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 bg-[#007aff] hover:bg-[#1a85fe] disabled:opacity-20 text-white font-black text-[13px] uppercase tracking-widest py-3 px-3 rounded-xl transition cursor-pointer shadow-3d-emerald"
              >
                Create Routine
              </button>
            </div>
