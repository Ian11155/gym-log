          ...
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="flex items-center gap-1.5 min-w-0 text-left">
              <span className="relative flex h-2 w-2 min-w-[8px]">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#5d8f56] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#5d8f56] font-extrabold"></span>
              </span>
              <p className="text-[13.5px] font-bold text-stone-250 truncate">
          ...
          <div className="absolute inset-0 z-55 flex items-center justify-center p-4 bg-black/85 animate-fade-in text-left font-sans">
            <div className="w-full max-w-sm bg-[#222222] border border-red-500/20 rounded-3xl p-6.5 shadow-[0_20px_50px_rgba(0,0,0,0.8)] space-y-4.5">
              ...
              <div className="space-y-1.5 text-center">
                <h4 className="text-[17px] font-bold text-stone-100">Discard Current Session?</h4>
              ...
              <div className="flex gap-2.5 pt-1.5">
                <button
                  ...
                  className="flex-1 bg-black/40 hover:bg-black/70 text-[13px] font-black uppercase tracking-widest py-2.5 rounded-xl text-stone-400 transition cursor-pointer border border-[#6f6d6c]/20"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 bg-red-600 hover:bg-red-500 text-white font-black text-[13px] uppercase tracking-widest py-2.5 rounded-xl transition cursor-pointer shadow-3d-sm"
                >
                  Discard Workout
                </button>
              </div>
      ...
      <div className="w-full bg-[#181818] pb-24 flex flex-col relative text-stone-100">
        ...
        <div className="sticky top-0 bg-black/95 px-4 py-4.5 border-b border-[#6f6d6c]/15 flex items-center justify-between z-10">
          <button
            ...
            className="flex items-center gap-1 text-[13px] font-black uppercase tracking-widest text-stone-400 hover:text-white transition cursor-pointer"
          >
          ...
          <div className="text-center">
            <div className="text-[11px] uppercase font-black text-stone-405 tracking-widest">Active Tracker</div>
            <div className="text-[15px] font-mono font-black text-stone-300 flex items-center gap-1 justify-center mt-0.5">
          ...
          <button
            ...
            className="bg-[#6f6d6c] hover:bg-[#868382] text-white font-black text-[13px] tracking-widest uppercase px-3.5 py-2.5 rounded-xl flex items-center gap-1.5 transition shadow-3d-sm cursor-pointer"
          >
        ...
        <div className="px-5 py-5 space-y-6 flex-1 text-left">
          ...
          <div className="bg-black border border-[#6f6d6c]/15 p-4 rounded-2xl space-y-4.5 shadow-3d-sm">
            <div>
              <label className="block text-[11px] uppercase font-black text-stone-400 tracking-widest mb-1.5">
                Session Title
              </label>
              <input
                type="text"
                ...
                className="w-full bg-black border border-[#6f6d6c]/15 rounded-xl px-3.5 py-3 text-[15px] font-bold text-stone-100 focus:outline-none focus:border-[#6f6d6c]/50 shadow-inner"
              />
            </div>
            <div>
              <label className="block text-[11px] uppercase font-black text-stone-400 tracking-widest mb-1.5">
              ...
              <textarea
                ...
                rows={2}
                className="w-full bg-black border border-[#6f6d6c]/15 rounded-xl px-3.5 py-2.5 text-[15px] text-stone-300 placeholder-stone-605 focus:outline-none focus:border-[#6f6d6c]/50 shadow-inner"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 pt-1">
              <div className="bg-black px-3 py-2 rounded-xl text-center border border-[#6f6d6c]/15">
                <span className="text-[11px] text-stone-450 uppercase tracking-widest font-black">Group Volume</span>
                <p className="font-mono text-[17px] font-black text-stone-200 mt-1">
                  {calculatedLiveVolume.toLocaleString()} <span className="text-[12px] text-stone-400 font-normal font-sans uppercase">kg</span>
                </p>
              </div>
              <div className="bg-black px-3 py-2 rounded-xl text-center border border-[#6f6d6c]/15">
                <span className="text-[11px] text-stone-450 uppercase tracking-widest font-black">Efficiency</span>
                <p className="font-mono text-[15px] font-bold text-stone-300 mt-1">
          ...
          <div className="space-y-6">
                ...
                <div key={le.id} className="bg-black border border-[#6f6d6c]/15 rounded-2xl p-4.5 space-y-4.5 shadow-3d-sm">
                  ...
                  <div className="flex items-center justify-between border-b border-[#6f6d6c]/10 pb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <span className="text-[11px] text-stone-300 font-bold uppercase tracking-widest bg-[#6f6d6c]/15 px-2 py-0.5 rounded border border-[#6f6d6c]/20">
                          Movement {exIdx + 1}
                        </span>
                        <h4 className="text-[15px] font-black text-stone-100 mt-1">{info.name}</h4>
                        <p className="text-[12px] text-[#8e8d8d] font-mono mt-0.5 tracking-wide font-black uppercase">{info.body_part}</p>
                      </div>
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="border-b border-[#6f6d6c]/10 text-[11px] text-[#8e8d8d] uppercase tracking-widest font-black">
                          ...
                          <th className="py-2 pr-1 text-center w-16">Tick</th>
                        </tr>
                      </thead>
                        ...
                        {le.sets.map((set, sIdx) => (
                          <tr
                            ...
                            className={`transition-all duration-155 ${
                              set.is_completed
                                ? "bg-[#5d8f56]/15 shadow-[inset_3px_0_0_rgba(93,143,86,0.78)]"
                                : ""
                            }`}
                          >
                            {/* Set Number tag */}
                            <td className={`py-2.5 pl-1 font-mono text-[15px] font-black ${
                              set.is_completed ? "text-[#c9e3c5]" : "text-stone-550"
                            }`}>
                              {sIdx + 1}
                            </td>
                            ...
                            <td className="py-1">
                              <select
                                ...
                                className={`text-[12px] font-bold uppercase border rounded-lg py-1 px-1 focus:outline-none font-sans ${
                                  set.is_completed
                                    ? "bg-[#5d8f56]/18 text-[#e6f2e4] border-[#5d8f56]/35 focus:border-[#5d8f56]/70"
                            ...
                            <td className="py-1 text-center font-mono">
                              <input
                                ...
                                className={`w-13 font-mono text-[15px] text-center font-black border rounded-lg py-1 px-0.5 focus:outline-none ${
                                  set.is_completed
                                    ? "bg-[#5d8f56]/18 text-[#f3faf2] border-[#5d8f56]/35 focus:border-[#5d8f56]/70"
                            ...
                            <td className="py-1 text-center">
                              <input
                                ...
                                className={`w-11 font-mono text-[15px] text-center font-black border rounded-lg py-1 px-0.5 focus:outline-none ${
                                  set.is_completed
                                    ? "bg-[#5d8f56]/18 text-[#f3faf2] border-[#5d8f56]/35 focus:border-[#5d8f56]/70"
                                    : "bg-black text-stone-200 border-[#6f6d6c]/15 focus:border-[#6f6d6c]/50"
                                }`}
                              ...
                              <div className="flex items-center justify-center gap-2">
                                <button
                                  ...
                                  className={`w-7 h-7 rounded-xl flex items-center justify-center transition-all border cursor-pointer ${
                                    set.is_completed
                                      ? "bg-[#5d8f56] border-[#9ec99a]/80 text-black font-black shadow-[0_0_14px_rgba(93,143,86,0.45)] hover:scale-105"
                                ...
                                <button
                                  ...
                                  className="text-stone-500 hover:text-rose-455 text-[19px] leading-none font-black w-7 h-7 flex items-center justify-center rounded-xl hover:bg-black cursor-pointer"
                  ...
                  <button
                    ...
                    className="w-full bg-black hover:bg-stone-900 text-[12px] font-black uppercase tracking-widest text-[#a3a3a6] hover:text-white py-2.5 rounded-xl border border-white/5 flex items-center justify-center gap-1 transition-all cursor-pointer shadow-3d-sm"
                  >
            ...
            {activeWorkout.exercises.length === 0 && (
              <div className="p-8 text-center bg-black rounded-2xl border border-dashed border-[#6f6d6c]/20 text-stone-500">
                ...
                <p className="text-[15px] font-semibold">No movements added in this session yet.</p>
                <p className="text-[13px] text-stone-550 mt-1 font-mono">Tap Add Exercise below to fetch your gym pool!</p>
              </div>
            )}
          </div>
          ...
          <div className="pt-2 flex flex-col gap-3">
            <button
              ...
              className="w-full bg-black hover:bg-stone-900 border border-[#6f6d6c]/20 text-stone-200 text-[13px] font-black uppercase tracking-widest py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer shadow-inner"
            >
            ...
            {isAddingExercise && (
              <div className="bg-black border border-[#6f6d6c]/15 rounded-2xl p-4.5 space-y-3.5 animate-fade-in shadow-3d-md">
                <div className="text-[12px] text-[#8e8d8d] font-black uppercase tracking-widest flex items-center justify-between font-sans">
                ...
                <input
                  ...
                  className="w-full bg-black border border-[#6f6d6c]/25 rounded-xl px-3 py-2 text-[15px] text-stone-100 placeholder-stone-600 focus:outline-none focus:border-[#6f6d6c]/50 font-sans shadow-inner"
                />
                ...
                <div className="flex gap-1 overflow-x-auto pb-1 no-scrollbar select-none">
                  {["All", "Chest", "Legs", "Back", "Shoulders", "Arms", "Core"].map((bp) => (
                    <button
                      ...
                      className={`text-[11px] font-black uppercase tracking-wider px-2.5 py-1 rounded-full transition-all cursor-pointer flex-shrink-0 ${
                        selectedBodyPart === bp
                ...
                <div className="max-h-52 overflow-y-auto space-y-1.5 pr-1 scrollbar-thin">
                  {filteredExercises.map((ex) => {
                    ...
                    <button
                      ...
                      className="w-full text-left bg-black px-3.5 py-3 rounded-xl text-[15px] text-stone-200 hover:bg-stone-900 hover:border-[#6f6d6c]/30 hover:text-stone-100 transition border border-white/5 flex items-center justify-between cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                      <span className="font-bold text-[14px]">{ex.name}</span>
                      <span className="text-[11px] bg-black text-stone-400 px-2 py-0.5 rounded font-mono font-black uppercase">
                  ...
                  {filteredExercises.length === 0 && (
                    <div className="p-4 text-center text-stone-500 text-[13px]">
                      No exercises found
                    </div>
                  )}
                </div>
            ...
            <button
              ...
              className="w-full bg-rose-505/5 hover:bg-rose-500/10 border border-rose-505/10 text-rose-500 text-[13px] font-black uppercase tracking-widest py-3.5 rounded-xl transition-all cursor-pointer shadow-3d-sm"
            >
              Discard Session
            </button>
          </div>
            ...
            <div className="w-full max-w-sm bg-[#222222] border border-red-500/20 rounded-3xl p-6.5 shadow-[0_20px_50px_rgba(0,0,0,0.8)] space-y-4.5">
              ...
              <div className="flex gap-2.5 pt-1.5">
                ...
                <button
                  ...
                  className="flex-1 bg-red-650 hover:bg-red-500 text-white font-black text-[13px] uppercase tracking-widest py-2.5 rounded-xl transition cursor-pointer shadow-3d-sm"
                >
                  Discard Workout
                </button>
              </div>
